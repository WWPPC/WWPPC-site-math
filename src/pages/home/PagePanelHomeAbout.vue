...
<template>
    <div class="fullBlock">
        ...
        <div class="aboutCreditsTable">
            ...
            <HomeAboutCreditsCard name="Arav Maheria" username="amaheria" roles="Problemsetter" img="/img/arav-maheria.jpg" grade="Rising Junior (HSS)" aops="502360" discord="713520364893765693" bio="A rising junior at High School South. Participated in math competitions like AMC, AIME, MMATHS, and CMIMC, and also attend coding competitions like PClassic and Cornell. For fun, spends time outdoors and loves taking photos for fun." external></HomeAboutCreditsCard>
